...
|---|---:|---:|---|
| aaaa | 0.0 | 8.0 | Entropy thấp vì tất cả ký tự giống nhau |
| abcd | 2.0 | 6.0 | Entropy cao hơn vì các ký tự đều khác nhau |
| hello world | 2.8 | 5.2 | Entropy trung bình với một số ký tự lặp lại |
